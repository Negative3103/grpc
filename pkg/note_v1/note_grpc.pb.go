...
type NoteV1Client interface {
	Create(ctx context.Context, in *CreateResuest, opts ...grpc.CallOption) (*CreateResponse, error)
...
func (c *noteV1Client) Create(ctx context.Context, in *CreateResuest, opts ...grpc.CallOption) (*CreateResponse, error) {
...
type NoteV1Server interface {
	Create(context.Context, *CreateResuest) (*CreateResponse, error)
...
func (UnimplementedNoteV1Server) Create(context.Context, *CreateResuest) (*CreateResponse, error) {
...
func _NoteV1_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NoteV1Server).Create(ctx, req.(*CreateResuest))
	}
